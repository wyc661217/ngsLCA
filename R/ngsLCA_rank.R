...
#'
#' @description Classify the combined taxa profile (and grouped taxa profiles generated by 'ngsLCA_group' if available) into user-defined taxonomic ranks. Results will be in 'path/run/taxonomic_profiles/taxa_ranks/'
#'
...
#' ## "extdata/lca_files/run01/taxonomic_profiles/taxa_ranks/".
#'
#'
